...
if st.session_state.game_active:
    with st.container(border=True):
        ...
        st.progress(float(st.session_state.lives_left / max_lives))
    ...
    with st.form(key="guess_form", clear_on_submit=True):
        ...
        # FIXED THIS LINE BELOW: Changed to st.form_submit_button
    ...
    if submit_guess and guess is not None:
        ...
        # Uses your exact warmth threshold calculation rule from line 10
        ...
        if guess < secret:
            ...
            # Your exact win banners and personal record rules
