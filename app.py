...
/* Bypasses native container limitations using your clean encoded local asset background */
.stApp, [data-testid='stAppViewContainer'] {{
    background-image: linear-gradient(rgba(26, 12, 18, 0.70), rgba(26, 12, 18, 0.82)), url("data:image/jpeg;base64,{bg_base64}") !important;
